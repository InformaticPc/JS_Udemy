'use strict';
// https://codingheroes.io/assignments/the-spread-operator
...
const newBook = {
  ...
  //   ℹ️ it takes the 1st element as property name and 2nd element as value ℹ️
};
console.log(newBook);
...
const newBook2 = {
  ...
  pages, // it will take the const name as property name and his value as value...
};
